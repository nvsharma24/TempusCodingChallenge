...
Refer to AnnotateVCF_v4.R script in the path nvsharma24/TempusCodingChallenge/AnnotateVCFwithExAC/R/  for more detailed information regarding inputs for AnnotatebyExac and query.exac().
